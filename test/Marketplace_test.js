...
contract('Marketplace', ([deployer, seller, buyer]) => {
    ...
    describe('products', async () => {
        ...
        it('sells products', async () => {
            ...
            // Check seller has received funds
            ...
            // FAILURE: Tries to buy a product that does not exist, i.e. input an invalid id
            await marketplace.purchaseProduct(99, {from: buyer, value: web3.utils.toWei('1', 'Ether')}).should.be.rejected
            // FAILURE: Buyer tries to buyer without enough ether
            await marketplace.purchaseProduct(productCount, {from: buyer, value: web3.utils.toWei('0.5', 'Ether')}).should.be.rejected
            // FAILURE: Deployer tries to buy the product, i.e. the product cannot be purchased twice
